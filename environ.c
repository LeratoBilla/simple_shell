 ...
 * @info: struct containing potential arguments maintain constant function prototype.
 * Return: Always 0
 */
...
/**
 * _myunsetenv -  this remove an environment variables
 * @info: struct containing potential arguments. maintain function prototype.
 * Return: Always 0
 */
